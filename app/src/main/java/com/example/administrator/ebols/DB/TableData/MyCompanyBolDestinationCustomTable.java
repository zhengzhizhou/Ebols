...
public class MyCompanyBolDestinationCustomTable{
    ...
    public static final String TableName = "MyCompanyBolDestinationCustomTable";
    ...
    public void InsertTable(List<Map<String, Object>> MyCompany, SQLiteDatabase sqLiteDatabase) {
        for(int i = 0; i<MyCompany.size(); i++){
            Map<String, Object> destination = (Map<String, Object>) MyCompany.get(i).get("destination");
            Map<String, Object> custom = (Map<String, Object>)destination.get("customer");
