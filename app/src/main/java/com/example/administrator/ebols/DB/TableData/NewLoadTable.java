...
public class NewLoadTable {
    private static final String Order_Table_Name = "newLoad_Order";
    ...
    public void InsertData(Map<String, Object> o, SQLiteDatabase sqLiteDatabase){
        SQLiteStatement stmt = sqLiteDatabase.compileStatement(INSERT_ORDER_TABLE);
        if(o.containsKey("id")){
            stmt.bindDouble(1, (Double)o.get("id"));
        }
        ...
        if(o.containsKey("billedDate")){
            stmt.bindString(10, (String)o.get("billedDate"));
        }
        if(o.containsKey("paidDate")){
            stmt.bindString(11, (String)o.get("paidDate"));
        }
        if(o.containsKey("totalPrice")){
            stmt.bindDouble(7, (double)o.get("totalPrice"));
        }
