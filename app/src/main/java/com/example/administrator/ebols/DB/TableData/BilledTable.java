...
public class BilledTable {
    private static final String Order_Table_Name = "Billed_Order";
        ...
        for(Map<String, Object> o : list){
            ...
            if(o.containsKey("payment")){
                ...
                if(payment.containsKey("paymentDate")){
                    stmt.bindDouble(79, (double)payment.get("paymentDate"));
                }
    ...
    public void InsertData(Map<String, Object> map, SQLiteDatabase sqLiteDatabase){
        ...
        if(map.containsKey("archivedDate")){
            stmt.bindDouble(9, (double)map.get("archivedDate"));
        }
        ...
        if(map.containsKey("billedDate")){
            stmt.bindDouble(10, (double)map.get("billedDate"));
        }
        if(map.containsKey("paidDate")){
            stmt.bindDouble(11, (double)map.get("paidDate"));
        }
